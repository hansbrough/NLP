...
(function(root, factory) {
  ...
  _.extend(Marionette.TemplateCache, {
    ...
    get: function(templateId) {
      //console.log("Marionette.TemplateCache get ",templateId);
  ...
  _.extend(Marionette.TemplateCache.prototype, {
    ...
    load: function() {
      ...
      //console.log("... template: ",template);//not waiting for async response...
  ...
  Marionette.Renderer = {
    ...
    render: function(template, data) {
      //console.log("Marionette.Renderer.render ",template, data);			
      if (!template) {
  ...
  Marionette.CompositeView = Marionette.CollectionView.extend({
    ...
    _initialEvents: function() {
      ...
      this.once('render', function() {
        //console.log("Marionette.CompositeView");
        if (this.collection) {
          this.listenTo(this.collection, 'add', this._onCollectionAdd);
          this.listenTo(this.collection, 'remove', this._onCollectionRemove);
  ...
  Marionette.LayoutView = Marionette.ItemView.extend({
    ...
    render: function() {
      //console.log("Marionette.LayoutView");
      this._ensureViewIsIntact();
